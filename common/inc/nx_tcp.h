...
#define NX_TCP_ID                       ((UINT32)0x54435020)


/* Define the TCP header typical size.  */

#define NX_TCP_HEADER_SIZE              ((UINT32)0x50000000) /* Typical 5 word TCP header    */
#define NX_TCP_SYN_HEADER               ((UINT32)0x70000000) /* SYN header with MSS option   */
...
#define NX_TCP_CONTROL_MASK             ((UINT32)0x00170000) /* ACK, RST, SYN, and FIN bits  */
#define NX_TCP_URG_BIT                  ((UINT32)0x00200000) /* Urgent data bit              */
#define NX_TCP_ACK_BIT                  ((UINT32)0x00100000) /* Acknowledgement bit          */
#define NX_TCP_PSH_BIT                  ((UINT32)0x00080000) /* Push bit                     */
#define NX_TCP_RST_BIT                  ((UINT32)0x00040000) /* Reset bit                    */
#define NX_TCP_SYN_BIT                  ((UINT32)0x00020000) /* Sequence bit                 */
#define NX_TCP_FIN_BIT                  ((UINT32)0x00010000) /* Finish bit                   */


/* Define the MSS option for the TCP header.  */

#define NX_TCP_MSS_OPTION               ((UINT32)0x02040000) /* Maximum Segment Size option  */
#ifdef NX_ENABLE_TCP_WINDOW_SCALING
#define NX_TCP_RWIN_OPTION              ((UINT32)0x03030000) /* 24 bits, so NOP, 0x3, 0x3, scale value  */
#endif /* NX_ENABLE_TCP_WINDOW_SCALING */
#define NX_TCP_MSS_SIZE                 1460                /* Maximum Segment Size         */
#define NX_TCP_OPTION_END               ((UINT32)0x01010100) /* NOPs and end of TCP options  */
...
typedef  struct NX_TCP_HEADER_STRUCT
{
     ...
     */
    UINT32 nx_tcp_acknowledgment_number;
     ...
     */
    UINT32 nx_tcp_header_word_4;
} NX_TCP_HEADER;


/* Define TCP component API function prototypes.  */

UINT _nxd_tcp_client_socket_connect(NX_TCP_SOCKET *socket_ptr, NXD_ADDRESS *server_ip, UINT server_port, UINT32 wait_option);
UINT _nxd_tcp_socket_peer_info_get(NX_TCP_SOCKET *socket_ptr, NXD_ADDRESS *peer_ip_address, UINT32 *peer_port);
UINT _nx_tcp_client_socket_bind(NX_TCP_SOCKET *socket_ptr, UINT port, UINT32 wait_option);
UINT _nx_tcp_client_socket_connect(NX_TCP_SOCKET *socket_ptr, UINT32 server_ip, UINT server_port, UINT32 wait_option);
...
UINT _nx_tcp_socket_info_get(NX_TCP_SOCKET *socket_ptr, UINT32 *tcp_packets_sent, UINT32 *tcp_bytes_sent,
                             UINT32 *tcp_packets_received, UINT32 *tcp_bytes_received,
...
UINT _nx_tcp_socket_mss_set(NX_TCP_SOCKET *socket_ptr, UINT32 mss);
...
UINT _nx_tcp_socket_transmit_configure(NX_TCP_SOCKET *socket_ptr, UINT32 max_queue_depth, UINT32 timeout,
...
VOID _nx_tcp_packet_send_ack(NX_TCP_SOCKET *socket_ptr, UINT32 tx_sequence);
...
UINT _nx_tcp_socket_peer_info_get(NX_TCP_SOCKET *socket_ptr, UINT32 *peer_ip_address, UINT32 *peer_port);
...
UINT _nxde_tcp_client_socket_connect(NX_TCP_SOCKET *socket_ptr, NXD_ADDRESS *server_ip, UINT server_port, UINT32 wait_option);
UINT _nxde_tcp_socket_peer_info_get(NX_TCP_SOCKET *socket_ptr, NXD_ADDRESS *peer_ip_address, UINT32 *peer_port);
...
UINT _nxe_tcp_info_get(NX_IP *ip_ptr, UINT32 *tcp_packets_sent, UINT32 *tcp_bytes_sent,
                       UINT32 *tcp_packets_received, UINT32 *tcp_bytes_received,
                       UINT32 *tcp_invalid_packets, UINT32 *tcp_receive_packets_dropped,
                       UINT32 *tcp_checksum_errors, UINT32 *tcp_connections,
                       UINT32 *tcp_disconnections, UINT32 *tcp_connections_dropped,
                       UINT32 *tcp_retransmit_packets);
UINT _nxe_tcp_server_socket_accept(NX_TCP_SOCKET *socket_ptr, UINT32 wait_option);
...
UINT _nxe_tcp_socket_disconnect(NX_TCP_SOCKET *socket_ptr, UINT32 wait_option);
UINT _nxe_tcp_socket_info_get(NX_TCP_SOCKET *socket_ptr, UINT32 *tcp_packets_sent, UINT32 *tcp_bytes_sent,
                              ...
                              UINT32 *tcp_transmit_queue_depth, UINT32 *tcp_transmit_window,
                              UINT32 *tcp_receive_window);
UINT _nxe_tcp_socket_mss_get(NX_TCP_SOCKET *socket_ptr, UINT32 *mss);
UINT _nxe_tcp_socket_mss_peer_get(NX_TCP_SOCKET *socket_ptr, UINT32 *peer_mss);
UINT _nxe_tcp_socket_mss_set(NX_TCP_SOCKET *socket_ptr, UINT32 mss);
UINT _nxe_tcp_socket_peer_info_get(NX_TCP_SOCKET *socket_ptr, UINT32 *peer_ip_address, UINT32 *peer_port);
UINT _nxe_tcp_socket_receive(NX_TCP_SOCKET *socket_ptr, NX_PACKET **packet_ptr, UINT32 wait_option);
...
UINT _nxe_tcp_socket_transmit_configure(NX_TCP_SOCKET *socket_ptr, UINT32 max_queue_depth, UINT32 timeout,
                                        UINT32 max_retries, UINT32 timeout_shift);
